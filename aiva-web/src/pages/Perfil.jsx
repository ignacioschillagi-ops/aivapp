    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: 'var(--bg)' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '0 20px 32px', display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          <span className="section-label">Instalar como app</span>
          <p style={{ fontSize: 13, color: 'var(--dark-50)', lineHeight: 1.6 }}>
            Podés agregar Aiva! a tu pantalla de inicio para usarla como una app nativa, sin abrir el navegador.
          </p>
          {[
            { icon: '🖥️', titulo: 'Chrome / Edge (escritorio)', pasos: 'Buscá el ícono de instalación (⊕) en la barra de direcciones y hacé click en "Instalar".' },
            { icon: '🤖', titulo: 'Chrome (Android)', pasos: 'Tocá los tres puntos del menú → "Agregar a pantalla de inicio".' },
            { icon: '🍎', titulo: 'Safari (iPhone / iPad)', pasos: 'Tocá el botón de compartir (□↑) → "Agregar a inicio".' },
          ].map(item => (
